...
if(isset($_POST) && isset($_POST['nombre']) && isset($_POST['orden']) ){
	$categoria = new Categoria($db, $_SESSION,$_POST, $idImagen, Comunes::SAVE);
	...
	$categoria = new Categoria($db, $_SESSION,$_POST, $idImagen,  Comunes::LISTAR);	
						...
						<div class="col-sm-12">
                          ...
                          <div class="col-md-6">
												...
												<div class="form-actions">
													<button class="btn btn-success btn-icon left-icon mr-10 pull-left" id="nuevoCategoria" name="nuevoCategoria"> <i class="fa fa-check"></i> <span>Crear</span></button>
