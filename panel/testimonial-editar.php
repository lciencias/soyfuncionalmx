...
if(isset($_POST) && isset($_POST['nombre']) && isset($_POST['testimonial'])){
	$testimonial = new Testimonial($db, $_SESSION,$_POST, $idImagen, Comunes::UPDATE);
	...
	$testimonial = new Testimonial($db, $_SESSION,$_GET, $idImagen, Comunes::EDIT);
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                      ...
                      <li><a href="<?=$_SESSION['pathWeb']?>admin.php">Inicio</a></li>
						...
						<li class="active"><span>Actualizar Testimonial</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form enctype="multipart/form-data" action="<?=$_SERVER['PHP_SELF']?>" method="post" name="formaSlider" id="validateFormTestimonial" autocomplete="off" data-toogle="validator" role="form">
											<input type="hidden" name="id"  id="id"  value="<?=$registros['id']?>" />
												<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Actualizar Testimonial</h6>
												<hr class="light-grey-hr"/>
                                                <div class="row">
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Nombre del visitante</label>
															<input type="text" id="nombre" name="nombre" tabindex="1" class="form-control required letras" placeholder="Nombre del visitante" value="<?=$registros['nombre']?>" maxlength="80">
														</div>
													</div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
														<div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="testimonial" tabindex="2" id="testimonial" placeholder="Testimonial"><?=$registros['testimonial']?></textarea>
														</div>
													</div>
                                                    <div class="seprator-block"></div>                                                
												</div>                                                                              
												<div class="form-actions">
													<button class="btn btn-success btn-icon left-icon mr-10 pull-left" id="actualizarTestimonial" name="actualizarTestimonial"> <i class="fa fa-check"></i> <span>Actualizar</span></button>
