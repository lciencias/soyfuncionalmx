...
if(isset($_POST) && isset($_POST['name']) && isset($_POST['email'])){
	$usuario = new Usuario($db, $_SESSION,$_POST, $idImagen, Comunes::UPDATE);
	...
	$usuario = new Usuario($db, $_SESSION,$_GET, $idImagen, Comunes::EDIT);
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" id="name" name="name" tabindex="1" class="form-control required letras" placeholder="Nombre Completo" maxlength="80" value="<?=$registros['name']?>">
														</div>
													</div>
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Correo Electr&oacute;nico</label>
															<input type="text" id="email" name="email" tabindex="2" class="form-control required email" placeholder="Correo Electr&oacute;nico" maxlength="100" value="<?=$registros['email']?>">
														</div>
													</div>
                                                    <div class="col-md-6">
														<div class="form-group">
															<label class="control-label mb-10">Contrase&ntilde;a</label>
															<input type="password" id="passwordS" name="passwordS" tabindex="3" class="form-control required alfa" placeholder="Contrase&ntilde;a" maxlength="20"  value="<?=$registros['passowrdS']?>">
														</div>
													</div>
													<div class="seprator-block"></div>                                            
												</div>                                       
												<div class="form-actions">
													<button class="btn btn-success btn-icon left-icon mr-10 pull-left" id="actualizarUsuario" name="actualizarUsuario"> <i class="fa fa-check"></i> <span>Actualizar</span></button>
