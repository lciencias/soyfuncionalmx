...
$slide = new Slider ($db,$_SESSION,$_POST,Comunes::LISTAR,Comunes::LISTAR,0);
$registros = $slide->obtenRegistros();
            ...
            <div class="container-fluid">				
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Listado Banner principal</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Listado de Banner</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
                                ...
                                <div class="pull-right">
									<a class="button" href="banner-nuevo.php">+ A&ntilde;adir Slide</a>
								</div>
                            ...
                            <th>Eliminar</th>
												...
												if(count($registros) > 0){
													foreach($registros as $reg){
														echo '<tr class="renglon'.$reg['idslide'].'">
																<td>'.$reg['nombre'].'</td>
																<td>'.$reg['fecha'].'</td>
																<td>
