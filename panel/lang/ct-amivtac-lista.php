...
$comite = new Comite($db, $_SESSION, $_REQUEST, Comunes::SAVE, Comunes::LISTAR);
$registros = $comite->obtenRegistros();
            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Lista Comit&eacute;s T&eacute;cnicos AMIVTAC</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Lista Comit&eacute;s T&eacute;cnicos AMIVTAC</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a class="button" href="ct-amivtac-nuevo.php">+ A&ntilde;adir Comit&eacute;</a>
								</div>
											...
											<table id="myTable1" class="table table-hover display  pb-30" >
												...
												if(count($registros) > 0){
													foreach($registros as $reg){
														echo '<tr class="renglon'.$reg['idcomite'].'">
																<td>'.$reg['nombre'].'</td>
																<td>'.$reg['fecha'].'</td>
																<td>
																	<a href="'.$path_web.'ct-amivtac-editar.php?id='.$reg['idcomite'].'&'.$db->url().'" id="m-'.$reg['idcomite'].'" class="editar">
																		<img src="'.$path_lib.'dist/img/icons/editar.png">
																	</a>
																</td>
																<td>
																	<a href="#" id="e-'.$reg['idcomite'].'-9" class="eliminar">
