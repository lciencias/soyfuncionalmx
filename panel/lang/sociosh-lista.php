...
$socio = new Socio($db,$_SESSION,$_POST,Comunes::LISTAR,Comunes::LISTAR);
$registros = $socio->obtenRegistros();
				...
				<div class="row heading-bg">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Lista Socios de Honor</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a class="button" href="sociosh-nuevo.php">+ A&ntilde;adir Socio</a>
								</div>
											...
											<table id="myTable1" class="table table-hover display  pb-30" >
												...
												if(count($registros) > 0){
													foreach($registros as $reg){
														echo '<tr class="renglon'.$reg['idsocio'].'">
																<td>'.$reg['nombre'].'</td>
																<td>'.$reg['fecha_reconocimiento'].'</td>
																<td>'.$reg['fecha'].'</td>
																<td>
																	<a href="'.$_SESSION['pathWeb'].'sociosh-editar.php?id='.$reg['idsocio'].'&'.$db->url().'" id="m-'.$reg['idsocio'].'" class="editar">
																		<img src="'.$path_lib.'dist/img/icons/editar.png">
																	</a>
																</td>
																<td>
																	<a href="#" id="e-'.$reg['idsocio'].'-5" class="eliminar">
