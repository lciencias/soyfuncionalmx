...
$comite = new Comite($db, $_SESSION, $_REQUEST, Comunes::EDIT, Comunes::LISTAR);
            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Lista Comit&eacute;s T&eacute;cnicos PIARC</h5>
					</div>
					<!-- Breadcrumb -->
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li class="active"><span>Lista Comit&eacute;s T&eacute;cnicos PIARC</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a class="button" href="ct-piarc-nuevo.php">+ A&ntilde;adir Comit&eacute;</a>
								</div>
												...
												if(count($registros) > 0){
													foreach($registros as $reg){
														echo '<tr class="renglon'.$reg['idcomite'].'">
																...
																<td>'.$reg['fecha'].'</td>
																<td>
																	<a href="'.$path_web.'ct-piarc-editar.php?id='.$reg['idcomite'].'&'.$db->url().'" id="m-'.$reg['idcomite'].'" class="editar">
