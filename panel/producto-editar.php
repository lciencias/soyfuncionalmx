...
if(isset($_GET) && isset($_GET['id']) && (int) $_GET['id'] > 0 ){
	$producto   = new Producto($db,$_SESSION,$_GET,Comunes::LISTAR,Comunes::LISTAR,Comunes::EDIT);
	$registro   = $producto->obtenRegistros();
...
if(isset($_POST) && isset($_POST['producto']) && isset($_POST['caloria']) && isset($_POST['precio'])){
	...
	$producto = new Producto($db, $_SESSION,$_POST, $idImagen, Comunes::LISTAR, Comunes::UPDATE);
					...
					<div class="row heading-bg">
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
								...
								<li class="active"><span>Editar Producto</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
									...
									<div class="panel-body">
										<div class="form-wrap">
											<form enctype="multipart/form-data" action="<?=$_SERVER['PHP_SELF']?>" method="post" name="formaSlider" id="validateFormProducto" autocomplete="off" data-toogle="validator" role="form">
												...
												<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Editar Producto</h6>
                        ...
                        <div class="row">
														...
														<div class="form-group">
															...
															if(count($categorias) > 0){
																foreach ($categorias as $key => $value){
																	$tmp = "";
																	if((int) $key == (int)$registro['idcategoria']){
																		$tmp = " selected ";
																	}
															?>
                          ...
                          <div class="col-md-4">
														<div class="form-group">
															...
															<input type="text" id="caloria" name="caloria" tabindex="3" value="<?=$registro['caloria']?>"  class="form-control required alfa" placeholder="calor&iacute;as">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
															<label class="control-label mb-10">Precio</label>
															<input type="text" id="precio" name="precio" tabindex="4" value="<?=$registro['precio']?>" class="form-control required numeros" placeholder="Precio">
														</div>
													</div>
													<div class="col-md-4">
														<div class="form-group">
												...
												<div class="row">
													<div class="col-lg-12">
														...
														<?php if((int)$registro['idimagen'] > 0){
															?>
															<img class="img-responsive" src="<?=$registro['imagen']?>" alt="upload_img">
															<?php 
															}else{
															?>
															<img class="img-responsive" src="<?=$_SESSION ['pathLib']?>dist/img/base-productos.jpg" alt="upload_img">
															<?php 	
															}
															?>
														</div>
												...
												<div class="form-actions">
													<button class="btn btn-success btn-icon left-icon mr-10 pull-left" id="actualizarProducto" name="actualizarProducto"> <i class="fa fa-check"></i> <span>Guardar</span></button>
													<button type="button" class="btn btn-warning pull-left cancelaRegistro" id="producto-lista.php">Cancelar</button>
